import { hasInjectionContext, getCurrentInstance, createApp, provide, toRef, onErrorCaptured, onServerPrefetch, unref, createVNode, resolveDynamicComponent, shallowReactive, reactive, effectScope, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, inject, defineAsyncComponent, mergeProps, ref, computed, getCurrentScope, watch, useSSRContext } from 'vue';
import { m as hasProtocol, n as isScriptProtocol, o as joinURL, w as withQuery, p as sanitizeStatusCode, q as getContext, $ as $fetch, t as createHooks, v as executeAsync, c as createError$1, x as toRouteMatcher, y as createRouter$1, z as defu } from '../nitro/nitro.mjs';
...
const NotificationBar = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__scopeId", "data-v-8aa7b3ef"]]);
...
const Header = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["__scopeId", "data-v-681acbd6"]]);
const _sfc_main$c = {
  __name: "Footer",
  __ssrInlineRender: true,
  setup(__props) {
...
const Footer = /* @__PURE__ */ _export_sfc(_sfc_main$c, [["__scopeId", "data-v-6492d0c3"]]);
const _sfc_main$b = {
  __name: "Cart",
  __ssrInlineRender: true,
  props: {
...
const Cart = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-da58be51"]]);
...
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div class="container mx-auto px-6 py-12" data-v-56a5ef09><div class="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8" data-v-56a5ef09><div class="lg:col-span-8" data-v-56a5ef09><div class="bg-white rounded-xl shadow-lg p-6" data-v-56a5ef09><div class="flex justify-between items-center mb-4" data-v-56a5ef09><h2 class="text-xl font-bold text-[#0a3a47]" data-v-56a5ef09>Shirt Designer</h2><div class="flex gap-2 relative z-20" data-v-56a5ef09><button class="btn-secondary" title="Zoom In" data-v-56a5ef09><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 7v3m0 0v3m0-3h3m-3 0H7" data-v-56a5ef09></path></svg></button><button class="btn-secondary" title="Zoom Out" data-v-56a5ef09><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0zM10 10v3m0-3H7" data-v-56a5ef09></path></svg></button><button class="btn-secondary" title="Zurücksetzen" data-v-56a5ef09><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" data-v-56a5ef09></path></svg></button><button class="btn-secondary" title="Design exportieren" data-v-56a5ef09><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" data-v-56a5ef09></path></svg></button>`);
      if (isAdminMode.value) {
        _push(`<div class="relative group" data-v-56a5ef09><button class="${ssrRenderClass([{ "bg-[#0a3a47] text-white": isDrawingPolygon.value || isEditingArea.value }, "btn-secondary"])}"${ssrRenderAttr("title", polygonButtonTitle.value)} data-v-56a5ef09><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4l16 16M4 20L20 4" data-v-56a5ef09></path></svg></button><span class="absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded bg-black text-white text-xs px-2 py-1 opacity-0 group-hover:opacity-100 pointer-events-none z-50" data-v-56a5ef09>${ssrInterpolate(polygonButtonHelp.value)}</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (isAdminMode.value && customPolygon.value.length >= 3) {
        _push(`<div class="relative group" data-v-56a5ef09><button class="${ssrRenderClass([{ "bg-[#D8127D] text-white": isEditingArea.value }, "btn-secondary"])}" title="Polygon bearbeiten" data-v-56a5ef09><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536M9 11l6.232-6.232a2 2 0 112.828 2.828L11.828 13.828a2 2 0 01-.828.515L7 15l1.657-3.999a2 2 0 01.343-.6z" data-v-56a5ef09></path></svg></button><span class="absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded bg-black text-white text-xs px-2 py-1 opacity-0 group-hover:opacity-100 pointer-events-none z-50" data-v-56a5ef09>Punkte verschieben</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="relative group" data-v-56a5ef09><button class="${ssrRenderClass([{ "bg-[#0a3a47] text-white": isAdminMode.value }, "btn-secondary"])}" title="Admin Mode" data-v-56a5ef09><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" data-v-56a5ef09></path></svg></button><span class="absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded bg-black text-white text-xs px-2 py-1 opacity-0 group-hover:opacity-100 pointer-events-none z-50" data-v-56a5ef09>Admin-Tools an/aus</span></div>`);
      if (isAdminMode.value) {
        _push(`<div class="relative group" data-v-56a5ef09><button class="btn-secondary" title="Area speichern" data-v-56a5ef09><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4h16v16H4zM8 12h8" data-v-56a5ef09></path></svg></button><span class="absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded bg-black text-white text-xs px-2 py-1 opacity-0 group-hover:opacity-100 pointer-events-none z-50" data-v-56a5ef09>Fläche speichern</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (isAdminMode.value) {
        _push(`<div class="relative group" data-v-56a5ef09><button class="btn-secondary" title="Area löschen" data-v-56a5ef09><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-56a5ef09></path></svg></button><span class="absolute -bottom-8 left-1/2 -translate-x-1/2 whitespace-nowrap rounded bg-black text-white text-xs px-2 py-1 opacity-0 group-hover:opacity-100 pointer-events-none z-50" data-v-56a5ef09>Fläche löschen</span></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div><div class="relative rounded-lg overflow-hidden" data-v-56a5ef09><canvas class="w-full h-[600px] cursor-crosshair" tabindex="0" data-v-56a5ef09></canvas>`);
      if (showWarning.value) {
        _push(`<div class="absolute top-4 left-1/2 transform -translate-x-1/2 bg-red-500 text-white px-4 py-2 rounded-lg shadow-lg z-10" data-v-56a5ef09><div class="flex items-center gap-2" data-v-56a5ef09><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-2.5L13.732 4c-.77-.833-1.964-.833-2.732 0L3.732 16.5c-.77.833.192 2.5 1.732 2.5z" data-v-56a5ef09></path></svg><span class="text-sm font-medium" data-v-56a5ef09>${ssrInterpolate(warningMessage.value)}</span></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="mt-2 text-xs text-gray-500" data-v-56a5ef09>Tipp: Objekte anklicken und mit der Maus ziehen, um sie zu bewegen.</div></div></div><div class="lg:col-span-4" data-v-56a5ef09><div class="bg-white rounded-xl shadow-lg p-6 flex flex-col gap-6" data-v-56a5ef09><div data-v-56a5ef09><h1 class="text-2xl font-bold mb-1" data-v-56a5ef09>${ssrInterpolate(productName.value)} <span class="text-xs text-gray-400" data-v-56a5ef09>#${ssrInterpolate(__props.productId)}</span></h1><div class="text-sm text-[#D8127D] font-semibold mb-2 flex items-center gap-2" data-v-56a5ef09></div></div><div data-v-56a5ef09><div class="space-y-3" data-v-56a5ef09><button class="btn w-full bg-[#D8127D] hover:bg-[#b0105f] text-white" data-v-56a5ef09><svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" data-v-56a5ef09></path></svg> Bild hochladen </button><input type="file" accept="image/*,.svg" class="hidden" data-v-56a5ef09><button class="btn w-full bg-[#ff7a00] hover:bg-[#ffa940] text-white" data-v-56a5ef09><svg class="w-4 h-4 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" data-v-56a5ef09></path></svg> Text hinzufügen </button></div></div>`);
      if (productImages.value && productImages.value.length) {
        _push(`<div class="mt-4" data-v-56a5ef09><h3 class="font-semibold mb-2 text-[#0a3a47]" data-v-56a5ef09>Ansichten</h3><div class="flex gap-2 overflow-x-auto pb-2" data-v-56a5ef09><!--[-->`);
        ssrRenderList(productImages.value, (u, i) => {
          _push(`<button class="${ssrRenderClass(["rounded-md border", i === currentViewIndex.value ? "ring-2 ring-[#D8127D] border-[#D8127D]" : "border-gray-200"])}" data-v-56a5ef09><img${ssrRenderAttr("src", u)}${ssrRenderAttr("alt", "View " + (i + 1))} class="w-16 h-16 object-cover rounded-md" data-v-56a5ef09></button>`);
        });
        _push(`<!--]--></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div data-v-56a5ef09><div class="font-semibold mb-2 text-[#0a3a47]" data-v-56a5ef09>Shirt Farbe</div><div class="grid grid-cols-8 gap-2 mb-2" data-v-56a5ef09><!--[-->`);
      ssrRenderList(colors, (color, i) => {
        _push(`<button${ssrRenderAttr("title", color.name)} class="${ssrRenderClass(["w-7 h-7 rounded-full border-2", selectedColor.value === i ? "border-[#D8127D] ring-2 ring-[#ffd44d]" : "border-gray-200"])}" style="${ssrRenderStyle({ backgroundColor: color.hex })}" data-v-56a5ef09></button>`);
      });
      _push(`<!--]--></div><div class="text-xs text-gray-500" data-v-56a5ef09>Gewählte Farbe: <span class="font-semibold text-[#0a3a47]" data-v-56a5ef09>${ssrInterpolate(colors[selectedColor.value].name)}</span></div></div>`);
      if (selectedObject.value) {
        _push(`<div data-v-56a5ef09><h3 class="font-semibold mb-3 text-[#0a3a47]" data-v-56a5ef09>Design bearbeiten</h3><div class="space-y-3" data-v-56a5ef09><div class="flex gap-2" data-v-56a5ef09><button class="btn-secondary flex-1" title="Nach vorne" data-v-56a5ef09><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 15l7-7 7 7" data-v-56a5ef09></path></svg></button><button class="btn-secondary flex-1" title="Nach hinten" data-v-56a5ef09><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" data-v-56a5ef09></path></svg></button><button class="btn-secondary" title="Löschen" data-v-56a5ef09><svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-56a5ef09><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" data-v-56a5ef09></path></svg></button></div>`);
        if (selectedObject.value.type === "text") {
          _push(`<div class="space-y-3 p-3 border border-gray-200 rounded-md bg-white shadow-sm" data-v-56a5ef09><div data-v-56a5ef09><label class="block text-xs font-medium text-gray-700 mb-1" data-v-56a5ef09>Text</label><input${ssrRenderAttr("value", selectedObject.value.text)} type="text" class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#D8127D]" data-v-56a5ef09></div><div data-v-56a5ef09><label class="block text-xs font-medium text-gray-700 mb-1" data-v-56a5ef09>Schriftgröße</label><input${ssrRenderAttr("value", selectedObject.value.fontSize)} type="range" min="12" max="72" class="w-full" data-v-56a5ef09><div class="text-xs text-gray-500 text-center" data-v-56a5ef09>${ssrInterpolate(selectedObject.value.fontSize)}px</div></div><div data-v-56a5ef09><label class="block text-xs font-medium text-gray-700 mb-1" data-v-56a5ef09>Farbe</label><div class="grid grid-cols-6 gap-1" data-v-56a5ef09><!--[-->`);
          ssrRenderList(textColors, (color) => {
            _push(`<button class="${ssrRenderClass(["w-6 h-6 rounded border", selectedObject.value.fill === color.hex ? "border-[#D8127D] ring-2" : "border-gray-200"])}" style="${ssrRenderStyle({ backgroundColor: color.hex })}"${ssrRenderAttr("title", color.name)} data-v-56a5ef09></button>`);
          });
          _push(`<!--]--></div></div><div data-v-56a5ef09><label class="block text-xs font-medium text-gray-700 mb-1" data-v-56a5ef09>Schriftart</label><select class="w-full px-3 py-2 border border-gray-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-[#D8127D]" data-v-56a5ef09><!--[-->`);
          ssrRenderList(availableFonts, (f) => {
            _push(`<option${ssrRenderAttr("value", f)} data-v-56a5ef09${ssrIncludeBooleanAttr(Array.isArray(selectedObject.value.fontFamily) ? ssrLooseContain(selectedObject.value.fontFamily, f) : ssrLooseEqual(selectedObject.value.fontFamily, f)) ? " selected" : ""}>${ssrInterpolate(f)}</option>`);
          });
        ...
        if (selectedObject.value.type === "image") {
          _push(`<div class="space-y-3" data-v-56a5ef09><div data-v-56a5ef09><label class="block text-xs font-medium text-gray-700 mb-1" data-v-56a5ef09>Transparenz</label><input${ssrRenderAttr("value", selectedObject.value.opacity)} type="range" min="0.1" max="1" step="0.1" class="w-full" data-v-56a5ef09><div class="text-xs text-gray-500 text-center" data-v-56a5ef09>${ssrInterpolate(Math.round(selectedObject.value.opacity * 100))}%</div></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div>`);
      ...
      _push(`<div data-v-56a5ef09><details class="mb-2" data-v-56a5ef09><summary class="cursor-pointer font-semibold text-[#D8127D]" data-v-56a5ef09>Produktinformationen</summary><div class="text-xs text-gray-600 mt-2" data-v-56a5ef09>${ssrInterpolate(productDescription.value || "Produktbeschreibung folgt.")}</div></details><details data-v-56a5ef09><summary class="cursor-pointer font-semibold text-[#D8127D]" data-v-56a5ef09>Aktueller Lagerbestand</summary><div class="text-xs text-gray-600 mt-2" data-v-56a5ef09>Viele Größen und Farben sofort verfügbar.</div></details></div><div class="bg-gray-50 rounded-lg p-4 flex flex-col gap-2" data-v-56a5ef09><div class="flex justify-between items-center" data-v-56a5ef09><span class="font-semibold text-[#0a3a47]" data-v-56a5ef09>Gesamtsumme</span><span class="text-lg font-bold text-[#D8127D]" data-v-56a5ef09>11,90 €</span></div><div class="text-xs text-gray-500" data-v-56a5ef09>inkl. MwSt. EU / inkl. Druckkosten / zzgl. <a href="#" class="underline text-[#D8127D]" data-v-56a5ef09>Versand</a></div><div class="text-sm text-[#0a3a47] font-semibold mt-2" data-v-56a5ef09>Lieferung in der Regel innerhalb von 4 Werktagen</div></div><button class="btn w-full bg-[#ff7a00] hover:bg-[#ffa940] text-white text-lg font-bold py-3 rounded-lg mt-2" data-v-56a5ef09> Größe und Menge wählen </button></div></div></div></div>`);
      if (showSizeModal.value) {
        _push(`<div class="fixed inset-0 z-50 flex items-center justify-center" data-v-56a5ef09><div class="absolute inset-0 bg-black/40" data-v-56a5ef09></div><div class="relative bg-white rounded-xl shadow-2xl w-full max-w-lg mx-4 p-6" data-v-56a5ef09><h3 class="text-lg font-semibold text-[#0a3a47] mb-4" data-v-56a5ef09>Größe und Menge wählen</h3><div class="space-y-3 max-h-[50vh] overflow-y-auto pr-1" data-v-56a5ef09><!--[-->`);
        ssrRenderList(availableSizes.value, (size) => {
          _push(`<div class="flex items-center justify-between gap-4" data-v-56a5ef09><div class="font-medium text-sm text-[#0a3a47]" data-v-56a5ef09>${ssrInterpolate(size)}</div><input type="number" min="0" step="1" class="w-24 px-3 py-2 border border-gray-300 rounded-md text-sm"${ssrRenderAttr("value", sizeQuantities.value[size])} data-v-56a5ef09></div>`);
        });
        _push(`<!--]--></div><div class="flex justify-end gap-2 mt-6" data-v-56a5ef09><button class="btn btn-secondary" data-v-56a5ef09>Abbrechen</button><button class="btn bg-[#ff7a00] hover:bg-[#ffa940] text-white" data-v-56a5ef09>Weiter zur Kasse</button></div></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<!--]-->`);
...
const DesignCreator = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-56a5ef09"]]);
const _sfc_main$7 = {
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!["Home", "ReadyToBuy", "CustomizationCreator", "ProductDetail", "Grossbestellung", "Checkout", "OrderConfirmation"].includes(currentPage.value)) {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-BayJvwzV.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-Dy7SJLPA.mjs'));
